...
public interface UserDisplayRepository extends JpaRepository<User, Integer>{
	...
	@Query("SELECT new com.arshiya.cr.icinbank.model.UserDisplay(u.username,a.accno,a.balance,s.accno,s.balance)" + "FROM User u ,Account a,Saccount s WHERE u.username=?1 and u.username=a.username and u.username=s.username")
